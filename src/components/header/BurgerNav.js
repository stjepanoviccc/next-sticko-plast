          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                ...
                <Link onClick={toggleMenu} href="/kontakt" className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white">Kontakt</Link>
              </div>
              <div className="py-6">
                ...
                <div className="flex items-center gap-x-4 text-white">
                  ...
                  <p className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7">Masarikova 37, Kisac, Srbija</p>
                </div>
                <div className="flex items-center gap-x-4 text-white">
